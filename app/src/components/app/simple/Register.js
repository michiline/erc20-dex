        ...
        <nav className='navbar navbar-expand-lg navbar-light bg-light'>
          ...
          <div className='collapse navbar-collapse'>
            <div className='navbar-nav'>
              ...
              <a className='nav-item nav-link' href='/register'>Register <span className='sr-only'>(current)</span></a>
          ...
          <div className='row login-row'>
            ...
            <div className='col-lg-4'>
              <form>
                ...
                <button onClick={this.onClick} type='submit' className='btn btn-secondary'>Register</button>
              </form>
            </div>
            <div className='col-lg-4' />
          </div>
